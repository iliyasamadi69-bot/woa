...
echo ""
echo "vless://${UUID}@94.130.50.12:80?encryption=none&security=tls&type=ws&sni=${SNI}&path=%2F#@Kakoolnews"
echo ""
echo "vless://${UUID}@63.141.252.203:80?encryption=none&security=tls&type=ws&sni=${SNI}&path=%2F#@Kakoolnews"
echo ""
echo "vless://${UUID}@50.7.5.83:80?encryption=none&security=tls&type=ws&sni=${SNI}&path=%2F#@Kakoolnews"
echo ""
echo "========================================"
echo ""
